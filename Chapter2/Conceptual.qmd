...
```{python}
#| execution: {iopub.execute_input: '2024-10-22T07:17:32.118067Z', iopub.status.busy: '2024-10-22T07:17:32.117767Z', iopub.status.idle: '2024-10-22T07:17:32.124503Z', shell.execute_reply: '2024-10-22T07:17:32.123645Z', shell.execute_reply.started: '2024-10-22T07:17:32.118041Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-10-22T07:17:32.126646Z', iopub.status.busy: '2024-10-22T07:17:32.126375Z', iopub.status.idle: '2024-10-22T07:17:33.521768Z', shell.execute_reply: '2024-10-22T07:17:33.520719Z', shell.execute_reply.started: '2024-10-22T07:17:32.126606Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-10-22T07:17:33.524027Z', iopub.status.busy: '2024-10-22T07:17:33.523664Z', iopub.status.idle: '2024-10-22T07:17:33.532155Z', shell.execute_reply: '2024-10-22T07:17:33.530950Z', shell.execute_reply.started: '2024-10-22T07:17:33.524005Z'}
import numpy as np
...
```{python}
#| execution: {iopub.execute_input: '2024-10-22T07:17:33.534273Z', iopub.status.busy: '2024-10-22T07:17:33.534008Z', iopub.status.idle: '2024-10-22T07:17:33.666453Z', shell.execute_reply: '2024-10-22T07:17:33.665377Z', shell.execute_reply.started: '2024-10-22T07:17:33.534239Z'}
...
```{python}
#| execution: {iopub.execute_input: '2024-10-22T07:17:33.668394Z', iopub.status.busy: '2024-10-22T07:17:33.668040Z', iopub.status.idle: '2024-10-22T07:17:33.769840Z', shell.execute_reply: '2024-10-22T07:17:33.768781Z', shell.execute_reply.started: '2024-10-22T07:17:33.668372Z'}
k = 3
...
```{python}
#| execution: {iopub.execute_input: '2024-10-22T07:17:33.776104Z', iopub.status.busy: '2024-10-22T07:17:33.775793Z', iopub.status.idle: '2024-10-22T07:17:33.874151Z', shell.execute_reply: '2024-10-22T07:17:33.873106Z', shell.execute_reply.started: '2024-10-22T07:17:33.776081Z'}
allDone();
```
